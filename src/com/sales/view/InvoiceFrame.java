...
import com.sales.controller.ControllerAction;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createLineButton.setBackground(new java.awt.Color(242, 242, 242));
    ...
    private final ControllerAction controller = new ControllerAction(this);
    private ITH invoicesTableModel;
    ...
    public ITH getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new ITH(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(ITH invoicesTableModel) {
